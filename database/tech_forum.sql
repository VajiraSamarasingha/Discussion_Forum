...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2023 at 05:36 AM
...
(4, 0, '13', 'this is mehuls answer 1.... to the above asked question....', '2023-07-04 06:45:49', 0, 0),
(5, 0, '13', 'rgua ua nt BIRWGEA baWEQWEHkah', '2023-07-05 11:44:56', 0, 0),
(6, 0, '12', 'using the connectivity query', '2023-07-06 06:49:11', 8, 0),
(7, 0, '14', 'the various stages are \r\nNew,Ready,Running,Blocked,Terminate', '2023-07-07 07:33:43', 9, 2),
(8, 0, '16', 'In the star topology there is a centralized hub. The communication between various nodes through the hub.\r\nIn this type of network there is a bottleneck of the centralized hub.It is widely used in LAN connection.', '2023-07-08 06:14:09', 9, 0),
(9, 0, '16', 'In the star topology there is a centralized hub. The communication between various nodes through the hub.\r\nIn this type of network there is a bottleneck of the centralized hub.It is widely used in LAN connection.', '2023-07-09 13:45:22', 9, 0),
(11, 0, '17', 'You can do it withing Borland or VC++ IDE & Compiler.', '0000-00-00 00:00:00', 8, 0),
(12, 0, '17', 'this is reply 1. and this reply is not 2nd...', '2023-07-13 03:49:44', 8, 0),
(13, 0, '17', 'scheduling algorithm is carried out by various methods such as first come first schedule,round robin scheduling,etc;', '2023-07-11 13:33:46', 8, 0),
(15, 0, '17', 'It has many method to explain the sheduling ', '2023-07-12 20:18:28', 12, 0),
(16, 0, '21', 'swing is swing and applet is not swing.', '2023-07-13 12:20:50', 17, 0),
(17, 0, '17', 'scheduling is....', '2023-07-18 11:49:44', 8, 0),
(18, 0, '11', 'i got the answer', '2023-07-18 13:06:22', 9, 0),
(20, 0, '12', 'connectivity with use of execute query and non-execute query\r\n', '2023-07-19 02:27:14', 8, 0),
(21, 0, '17', '\r\n', '2023-07-21 12:30:38', 8, 0),
(22, 0, '29', 'the thread is sub process...', '2023-07-24 14:41:23', 30, 0),
(23, 0, '29', 'are vah', '2023-07-24 14:54:00', 8, 0),
(24, 0, '31', '>This problem is faced with several of people all you have to do is make it stop doing MIME sniffing. You can disable this MIME sniffing by selecting IE the go to tools then to internet options then click custom level after that select Miscellaneous section. After that scroll down in this section then check enable underâ€ open files based on content, not the file extensionâ€', '2023-07-25 13:48:39', 12, 0),
(25, 0, '32', 'The problem was with the theme. Actually it was customized video game theme that was causing the error. Now its working proper.', '2023-07-25 13:49:35', 12, 0),
(26, 0, '32', 'Can you post a screenshot of the problem ? Even I had never seen such problem that notifications turned black. If possible post the screenshot so that I can see what type of pop message in black color is coming in laptop. Till than you can try setting some another them and see if it works. Hope it will work.', '2023-07-25 13:50:25', 9, 0),
(27, 0, '33', 'As i have doubt if you could reset it from the safe mode. But you can surely do it with the help of an application called \"Windows Password Key\". Here is the step by step process for doing the same:\r\n\r\n\r\nâ€¢	Download Windows Password key from http://www.lostwindowspassword.com/downloads/Windows_Password_Key_Standard_Demo.exe.\r\nâ€¢	Install it on any other PC that you can access easily.\r\nâ€¢	Now you need to burn a bootable CD/DVD Or better create a USB Flash Drive.\r\nâ€¢	Connect this USB or insert bootable DVD to your Windows 8 system and recover the password.\r\nThats it. \r\n', '2023-07-25 13:50:59', 9, 0),
(28, 0, '34', 'C:WindowsSystem32shutdown.exe -s -t 0 -f', '2023-07-25 13:54:52', 9, 0),
(29, 0, '35', 'I have read your question and I would keen to tell you that you can use Mozilla Firefox 10 in Linux-32 bit but before you do that you have to visit official site of the Mozilla Firefox. After that you need to select system and language below download option and then choose Linux installed and download that in your machine. Now you have to install it in your machine. I guess this will bring an end to your problem.', '2023-07-25 14:07:16', 12, 0),
(30, 0, '36', 'Hi friends, as o know there are many users who are really in need of the Google chrome themes but are unable to install the same. So I have started this thread to give you people a fair idea regarding the same. So now to install the theme you just need to follow the below mentioned steps:\r\n\r\nStep 1: Start Google Chrome and go to this web address . Google runs its own themes, in fact online.\r\n\r\nStep 2: Navigate in the themes and click Apply Theme, once it is selected.\r\n\r\nStep 3: Downloading and installation are automatic, and your theme is applied instantly. However, you can cancel it by clicking the Cancel button in the upper right of the browser!', '2023-07-25 14:16:37', 9, 0),
(31, 0, '37', 'Happili.com is deeply infiltrated into victimsâ€™ system. To remove Happili.com, please follow below instruction:\r\n1.       reboot your system into safe mode with networking;\r\n2.       download Anvi Smart Defender and install it;\r\n3.       Fully scan your computer;\r\n4.       delete Happili.com Redirect Virus related file:\r\nQuote\r\n    * %AllUsersProfile%{random}\r\n    * %AllUsersProfile%{random}*.lnk\r\n    * HKEY_CURRENT_USERSoftwareMicrosoftWindowsCurrentVersionRunOnce [RANDOM]\r\n    * HKEY_CURRENT_USERSoftwareMicrosoftWindowsCurrentVersionRun [RANDOM]\r\n    * HKEY_LOCAL_MACHINESOFTWAREMicrosoftWindowsCurrentVersionRun [RANDOM].exe\r\n    * HKEY_CURRENT_USERSoftware[RANDOM]\r\n5.  restart your computer;\r\n', '2023-07-25 14:27:26', 15, 0),
...
(13, '2023-07-17 14:28:03', 'hi fabin im hardik', 8, 5),
(14, '2023-07-17 14:28:22', 'ka vikla', 8, 6),
(15, '2023-07-17 14:41:26', 'hi', 9, 5),
(16, '2023-07-17 14:42:12', 'how r u', 9, 5),
(17, '2023-07-17 14:42:55', 'hello', 9, 5),
(18, '2023-07-17 14:43:32', 'hi', 9, 5),
(19, '2023-07-17 14:43:52', 'kaise ho ?', 9, 5),
(20, '2023-07-17 14:43:58', 'm fine', 9, 5),
(21, '2023-07-17 14:44:36', 'this is hardik', 9, 5),
(22, '2023-07-17 14:46:39', 'now its fine', 9, 5),
(23, '2023-07-17 14:46:49', 'hardik here', 8, 5),
(24, '2023-07-18 09:37:31', 'shu karo 6o', 5, 7),
(25, '2023-07-18 09:41:37', 'are hardik hu hato ato', 12, 8),
(26, '2023-07-18 09:46:28', 'are shu photo mast mukyo 6e', 8, 9),
(27, '2023-07-19 12:12:32', 'are dipak avyo 6e ', 12, 8),
(28, '2023-07-21 11:53:43', 'hi\r\n', 8, 10),
(32, '2023-07-24 08:12:28', 'aaaaaaa', 5, 13),
(35, '2023-07-24 14:52:42', 'shu bhai', 30, 16),
(36, '2023-07-26 13:08:05', 'what is message passing system in the distributed application?', 9, 17),
(37, '2023-07-26 13:09:39', 'why synchronization require in the distributed system? ', 9, 18),
(38, '2023-07-27 04:46:00', 'how is your work going on?\r\n', 8, 19),
(39, '2023-07-25 07:08:31', 'ddddddddd', 5, 20),
(40, '2023-07-15 12:37:56', 'hi', 5, 7),
(41, '2023-07-16 07:44:49', 'Hi kasun', 33, 21);
...
(7, 'table connectivity', 'query of the connecting table with form?', '2023-07-11 09:42:44', 8, 7, 9),
(8, 'Window Xp', 'how to debbuge the ble screen error?', '2023-07-11 00:25:00', 8, 5, 1),
(9, 'Window vista', 'hot to change the administrator password from cmd?', '2023-07-03 17:51:44', 8, 5, 0),
(10, 'Window 7', 'how to make uninstall set up? ', '2023-07-05 02:24:42', 8, 5, 3),
(11, 'linux', 'how to use the live source of l\r\n', '2023-07-07 00:51:42', 9, 5, 6),
(12, 'connectivity', 'how to connect form with database?', '2023-07-09 09:01:36', 8, 2, 5),
(14, 'Thread life cycle', 'What are the different stages of thread life cycle?\r\n', '2023-07-09 23:04:43', 9, 12, 189),
(15, 'applet controls ', 'how to create simple applet program? ', '2023-07-12 12:02:44', 9, 13, 6),
(16, 'STAR topology', 'how connection established in the star topology?\r\n', '2023-07-26 22:14:01', 9, 17, 5),
(17, 'Scheduling', 'Hello,\r\n\r\nI want to create a program that supports multi-threading with scheduling. The program must', '2023-07-17 15:41:54', 8, 12, 79),
(18, 'Sheduling algorithm', 'Explain the various scheduling algorithm?\r\n', '2023-07-11 13:13:25', 8, 0, 0),
(19, 'Sheduling algorithm', 'Explain the various scheduling algorithm?\r\n', '2023-07-11 13:13:54', 8, 0, 1),
(20, 'scheduling algorithm', 'Explain various scheduling algorithm used in the cpu scheduling?', '2023-07-11 13:18:47', 8, 12, 9),
(21, 'Swing Applet', 'I want to know the difference between normal Applet and Swing Applet.....\r\n\r\nAnd I also want to know', '2023-07-13 12:13:35', 16, 13, 12),
(22, 'Applet Class', 'What is applet class ?', '2023-07-13 13:13:37', 26, 13, 2),
(23, 'what is applet ?', 'what is applet ?\r\n\r\nIs it as class or package ?', '2023-07-13 13:18:45', 27, 13, 4),
(24, 'a', '', '2023-07-21 12:53:31', 8, 12, 0),
(25, 'thread ', 'explain the  various stages of thread', '2023-07-22 05:39:06', 8, 12, 6),
(26, '', '', '2023-07-24 04:15:11', 8, 12, 0),
(27, 'a', '', '2023-07-24 04:15:33', 8, 12, 0),
(28, 'a', '', '2023-07-24 04:17:32', 8, 12, 0),
(29, 'what', 'what is what', '2023-07-24 14:18:15', 28, 12, 7),
(30, 'What is thread ?', 'What is thread ?', '2023-07-24 14:38:03', 29, 12, 1),
(33, 'window 8', 'How can i recover lost windows 8 Administrator password?', '2023-07-25 13:27:06', 8, 12, 4),
...
(43, 'How to write link list', 'i need java and c', '2023-07-15 13:08:39', 33, 19, 3);
...
(5, 'Sri Lanka', 'Western', '-', 'admin', 'admin', 'administrator', 'admin', NULL, '2012-04-17', 'admin@gmail.com', '1', 'ups/admin.jpg', 1),
(8, '-Sri lanka', '-Sabaragamu', '-', 'user', 'Kasun', 'Kasun Presath', '123', NULL, '0000-00-00', 'kasun@gmail.com', '1', 'ups/hardik.jpg', 0),
(9, 'Sri Lanka', 'Easten', 'Anuradhapura', 'user', 'Mahela', 'Mahela Perera', 'fabinlj', NULL, '0000-00-00', 'mahela@gmail.com', '1', 'ups/124.jpg', 0),
(12, 'Sri Lanka', 'Western', '', 'user', 'Sumith', 'Sumith Srinath', 'vikas', NULL, '1990-04-03', 'sumith@gmail.com', '1', 'ups/1.jpg', 1),
(15, 'Sri Lanka', 'North', 'Jefna', 'user', 'mahesh', 'mahesh sampath', 'm', NULL, '1990-04-27', 'mahesh.narvani@gmail.com', '1', 'ups/Pink Rose For You-504352.jpeg', 0),
(27, 'Sri Lanka', 'Sabaragamu', 'Pitipana,Homagama ', 'user', 'Nirupa', 'Nirupa senadeera', 'jasmin', NULL, '1986-11-25', 'jasmin.patel@gmail.com', '1', 'ups/7.jpg', 0),
(28, 'Sri Lanka', 'Sabaragamu', 'Hidellana,Ratnapura', 'user', 'Ruwan', 'Ruwan Chamara', 'rest', NULL, '0000-00-00', 'ruwan@gmail.com', '1', 'ups/', 0),
(30, 'Sri LAnka', 'Western', 'j', 'user', 'Madhura', 'Madhura Subash', '123', NULL, '1986-11-25', 'madhura@gmail.com', '1', 'ups/1.jpg', 0),
(31, 'Sri Lanka', 'Sabaragamu', 'Awissawella', 'user', 'Santhush', 'Santhus Weeraman', 'satish', NULL, '0000-00-00', 'satish.babariya@gmail.com', '1', 'ups/Red Roses Love-262228.jpeg', 0),
(32, 'Sri Lanka', 'Easten', '-', 'user', 'Abesiri', 'Abesiri Yashmith', '123', NULL, '1986-11-25', 'ab@gmail.com', '1', 'ups/Colorized Heart-733225.jpeg', 0),
(33, 'Sri Lanka', 'sabaragamu', 'Gabbela,\r\nHidellana,\r\nRatnapura', 'user', 'Vajira Samarasingha', 'Vajira Samarasingha', 'Vajira123', NULL, '0000-00-00', 'samarasingha0784528396@gmail.com', '1', 'ups/WhatsApp Image 2023-05-10 at 08.18.16.jpg', 0);
...
--
ALTER TABLE `chat`
  MODIFY `chatdetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
